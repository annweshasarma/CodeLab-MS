...
// importing the functions from the react context created
const { Search } = Input;
const Video = () => {
  const {
    call,
  ...
  return (
    <div className="grid">
   {/* video streaming for the main individual */}
      {stream ? (
        <div
...
{/* checking the video and the mic status */}
